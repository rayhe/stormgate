/*$Id: config.h,v 1.25 2005/04/11 03:25:02 tyrion Exp $*/
...
#define BET_LIMIT	50000
#define BET_LIMIT_STR	"50000"
 ...
 * 
 * This is a variable used internally to automatically update a
 * players pfile, its hard to explain
 *
 */

#define CURRENT_PLAYER_UPDATE	130

/*
 * This is a variable used internally to automatically update an
 * area after changes have been made.
 *
 */

#define CURRENT_AREA_VERSION 107
...
/*
 * Uncomment to enable SQL Support for the mud
 * 
 * - Ahsile
 *
 */
 ...
 */
/*
 * Hard coded anti-editing. Use this to make sure
 * your main port is stable (ie no imms screwing
 * around editing things.
 *
 * - Ahsile
 *
 */
 //#define DISABLE_EDITS_SAVES

/* 
 * Random timequakes (AH WELL)
 * - Ahsile
 */
...
/* 
 * Uncomment to debug memory  (only for SSM.c)
 * This replaces free_string with a debug copy that logs usage for us
 * It is very slow (no hash table lookup) but stable for debugging
 * - Ahsile
 */
...
/*
 * Win32 Define for cross-platform usability. A MS VS6 Project file should
 * be included with the mud anyway, which defines this at a project level,
 * so it shouldn't be necessary. I've just added this here as a reminder that
 * I did port this to run on Windows.
 *
 * In the absence of shell scripting, I did have to write another program to
 * babysit the mud though. StormLoader should be in a subdir of src.
 *
 * - Ahsile
 *
 */

 /* #define RUN_AS_WIN32SERVICE
 */
